...
**Tests**: Test tasks are **MANDATORY** for this project per Constitution Principle VIII (Test-First Development, NON-NEGOTIABLE). Every user story MUST include test tasks at the appropriate layer (lexer, parser, sema, dialect, lowering, end-to-end) per Constitution Principle VI. Tests MUST be written and observed FAILING before the corresponding implementation tasks begin.
