...
- The dialect op set is **M4-frozen** per [`specs/007-m4-mlir-dialect/contracts/dialect-api.contract.md`](../007-m4-mlir-dialect/contracts/dialect-api.contract.md) §2 (48 public types/functions per Q6 in the M4 Clarifications). No new `nsl::*` op is added at M5; if a structural-expansion pass surfaces a missing op, that is a M4-contract amendment, not a stealth M5 addition.
