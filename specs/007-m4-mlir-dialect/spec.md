...
- **FR-010**: The full op table — the dialect's M4 surface — is:
  ...
  | Procedure | `nsl.func` | `NSL_FuncOp` | `Symbol`, parent = `nsl::ModuleOp`; scoped-name supported via attribute | design §7 line 924 |
...
- **FR-013**: The structural-invariant set per op is enumerated
  ...
  | `nsl.connect` | parent = `nsl.module`; operand types match |
