...
the dialect class, the 35 op classes, the 3 type classes, and the
...
|---|---|---|
| `nsl::dialect::NSLDialect` | (TableGen-generated) | The MLIR dialect class. Inherits `mlir::Dialect`. Constructor calls `addOperations<...>()` and `addTypes<...>()` to register the 35 ops + 3 types. |
...
The 35 ops, in the same category-grouping as spec FR-010. Each row
...
|---|---|---|---|
| `test/Dialect/<category>/<op>_roundtrip.mlir` | 35 | FR-017 | Per-op round-trip pass fixture |
